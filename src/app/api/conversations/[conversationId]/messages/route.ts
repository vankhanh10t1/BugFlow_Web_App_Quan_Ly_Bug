...
export async function GET(request: Request, { params }: Context) {
  try {
    ...
    return apiSuccess(await listMessages((await params).conversationId, await requireActiveUser(), { cursor: url.searchParams.get("cursor") || undefined, after, limit }), "Đã tải tin nhắn");
