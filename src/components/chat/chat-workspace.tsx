...
}, (previous, next) => previous.mine === next.mine && previous.selected === next.selected && messageVisualKey(previous.message) === messageVisualKey(next.message));
